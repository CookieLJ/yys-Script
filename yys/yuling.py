...
def begin():
	startImg = cv2.imread('D:\yys\yuling\start.png', 0)
	endImg = cv2.imread('d:\yys\yuling\end.png', 0)
	fudaiImg = cv2.imread("d:\yys\yuling\click.png", 0)
	n = input("Number limit:")
	n = int(n)
	return startImg, endImg, fudaiImg, n
...
if __name__ == '__main__':
	startImg, endImg, fudaiImg, n = begin()
	for k in range(1, n + 1):
		print 'start to yuhun'
		display(k)
		matchTouch(startImg)
		print ('fighting...wait...')
		randomDelay(35, 35)  # 可写成键入等待
